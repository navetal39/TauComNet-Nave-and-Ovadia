...
int main(int argc, char *argv[]){
        ...
        struct mail emails[MAXEMAILS], myEmails[MAXEMAILS];
        ...
        while (1){
                listen(srvSock,1);
                clientSock = accept(srvSock,(struct sockaddr*) &clientAddr,addrSize);
                if(clientSock != -1){
                        ...
                        while(!strcmp(command[0],"4")){
                                ...
                                if(!strcmp(command[0], "1")){
                                        ...
                                        for(count = 0;count<myEmailAmount;++count){
                                                if(myEmails[count].tempID != 0){
                                                        strcat(inbox,emails[count].to[curTo].id);
                                                        strcat(inbox," ");
                                                        strcat(inbox, emails[count].from);
                                                        strcat(inbox, " ");
                                                        strcat(inbox, emails[count].subject);
                                                        strcat(inbox, '\n');
                                                }
                                        }
                                ...
                                /* Case "Compose" */
                                        ...
                                        char *token;
                                        count = 0;
                                        while((token = strsep(&toName,',')) != NULL){
